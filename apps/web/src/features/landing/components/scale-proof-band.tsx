...
export function ScaleProofBand() {
    ...
    return (
        <section className="w-full bg-surface text-text-primary py-12 px-6 border-y border-divider relative overflow-hidden">
            ...
            <div className="mx-auto max-w-[1100px] relative z-10">
                ...
                <div className="grid gap-6 grid-cols-2 lg:grid-cols-5 text-center sm:text-left">
                    ...
                    <div className="space-y-1">
                        <span className="text-2xl font-extrabold text-primary tracking-tight block">
                    ...
                    {/* Stat 2 */}
                    <div className="space-y-1">
                        <span className="text-2xl font-extrabold text-info tracking-tight block">
                    ...
                    <div className="space-y-1 col-span-2 sm:col-span-1 border-t sm:border-t-0 sm:border-l border-divider pt-4 sm:pt-0 sm:pl-6">
