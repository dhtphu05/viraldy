...
from viraldy.modules.product_events.repository import (
    ProductEventRepository,
    SyncProductEventRepository,
)
...
class SyncProductEventPublisher:
    def __init__(self, session: Session) -> None:
        self._repository = SyncProductEventRepository(session)
