...
class ProductModel(Base):
    ...
    __table_args__ = (
        Index("ix_products_workspace_status_created", "workspace_id", "status", "created_at"),
    )
    ...
    product_context_version: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
